...
<section class="band band-about"><div class="wrap">
  ...
  <div class="cols">
    ...
    <div class="band-ph-wrap" data-rv="rise"><figure class="band-ph"><img src="assets/img/home/about.jpg"
      width="1000" height="665" loading="lazy" decoding="async"
      alt="A businesswoman in a black suit holding a folder outside an office."></figure></div>
  </div>
</div></section>
...
<section id="cohorts"><div class="wrap">
  ...
  <div class="cohorts">
    <a class="cohort c-biz" href="women-at-business.html" data-rv="rise"><div class="row">
      ...
      <span class="ph"><img src="assets/img/home/cohort-business.jpg" width="800" height="600"
        loading="lazy" decoding="async" alt="A young woman holding a laptop outside a glass office building."></span>
      <div>
    ...
    <a class="cohort c-work" href="women-at-work.html" data-rv="rise"><div class="row">
      ...
      <span class="ph"><img src="assets/img/home/cohort-work.jpg" width="800" height="600"
        loading="lazy" decoding="async" alt="A woman at work on a machine line in a textile factory."></span>
      <div>
        <h3>Women at Work</h3>
    ...
    <a class="cohort c-home" href="women-at-home.html" data-rv="rise"><div class="row">
      ...
      <span class="ph"><img src="assets/img/home/cohort-home.jpg" width="800" height="600"
        loading="lazy" decoding="async" alt="A smiling woman in a printed shawl standing in a colonnade."></span>
      <div>
        <h3>Women at Home</h3>
    ...
    <a class="cohort c-und" href="underprivileged-women.html" data-rv="rise"><div class="row">
      ...
      <span class="ph"><img src="assets/img/home/cohort-underprivileged.jpg" width="800" height="600"
        loading="lazy" decoding="async" alt="Women artisans weaving and painting baskets and pots."></span>
      <div>
...
<section><div class="wrap">
  ...
  <div class="people">
    <article>
      <img class="face" src="assets/img/people/uma-g-reddy.jpg" width="480" height="600"
        loading="lazy" decoding="async" alt="Uma G Reddy">
      <h3>Uma G Reddy</h3>
    ...
    <article style="--d:130ms">
      <img class="face" src="assets/img/people/narasimhan-mv.jpg" width="480" height="600"
        loading="lazy" decoding="async" alt="Narasimhan M.V">
    ...
    <article style="--d:260ms">
      <img class="face" src="assets/img/people/jaya-reddy.jpg" width="480" height="600"
        loading="lazy" decoding="async" alt="Jaya Reddy">
      <h3>Jaya Reddy</h3>
